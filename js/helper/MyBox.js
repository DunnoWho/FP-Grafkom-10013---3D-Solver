class MyBox extends MySolid{
    constructor(meshMaterial, lineMaterial, length=1, width=1, height=1){
        ...
        const lines = [
            ...
            [pts[1].clone(), pts[5].clone()],
            [pts[2].clone(), pts[6].clone()],
            [pts[3].clone(), pts[7].clone()],
            [pts[4].clone(), pts[5].clone()],
            [pts[5].clone(), pts[6].clone()],
            [pts[6].clone(), pts[7].clone()],
            [pts[7].clone(), pts[4].clone()]
        ];
